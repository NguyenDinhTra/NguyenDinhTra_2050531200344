package com.example.nguyendinhtra_cayxanh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dangki1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mhdangki=new Intent(MainActivity2.this,MainActivity.class);
                                    ...
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                Toast.makeText(MainActivity2.this,"Đăng ký không thành công, Đăng ký lại!",Toast.LENGTH_SHORT).show();
